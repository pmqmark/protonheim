    ...
    <>
      <main className="max-w-[1180px] mx-auto w-full py-10 lg:pt-20 min-h-screen bg-white">
        <section className="min-h-screen flex flex-col items-center justify-center gap-5 p-3 my-16 lg:my-0 overflow-hidden">
          <div className="text-center space-y-5 lg:space-y-10">
            <h5 className="font-gilroy text-[14px] text-[#25AAE1]">
              OUR PRODUCTS
            </h5>
            <div className="w-full ">
              <section className=" font-gilroy text-4xl font-normal leading-[48px] tracking-custom text-black">
          ...
          <div className="flex md:flex-wrap gap-5 mt-10 lg:mt-20 w-full overflow-x-scroll">
            <div className="text-center lg:w-60 flex-shrink-0">
              <img
                src={product1}
                alt="FlySky CT6B"
        ...
        <section className="py-10 w-full p-3">
          <div className="text-center mb-10 lg:mb-20 flex flex-col items-center">
            <span className=" font-gilroy text-4xl font-normal leading-[48px] tracking-custom text-black">
          ...
          <div className="flex flex-col md:flex-row justify-center items-start gap-4 lg:gap-16">
            <img src={flyskyimg} alt="FlySky CT6B" className="mx-auto w-full" />
        ...
        <section className="my-10 md:my-20 w-full p-3">
          <div className="">
            <h1 className="text-4xl font-normal mb-8 ">Description</h1>
            <div className="text-left  text-sm tracking-wide leading-6 font-gilroy1  mb-12 text-[#161C2D]">
              <p className="text-wrap">
                ...
                without it because
                it uses radio signals to send commands wirelessly to a Radio
                Receiver. And Flysky is one of the popular brands that only
                manufactures
                Diverse Range of high-quality Transmitters and Receivers at an
                affordable price.
                <br />
                Flysky CT6B 2.4 GHz 6CH transmitter is an entry-level 2.4 GHz
                radio system offering the reliability of 2.4 GHz signal
                technology and a 
                receiver .it is ideal for quadcopters and multirotor that
                require the 6ch operation.
                <br />
                FlySky Transmitter and Receiver is gaining so much popularity
                due to its originality and compatibility in high-end drone
                projects and
                Industrial people are interested in this type of Transmitter.
                <br />
          ...
          <div className="mb-10">
            <h1 className="text-4xl font-normal mb-8">Features</h1>
          ...
          <div className="my-12">
            <h1 className="text-4xl font-normal mb-8 ">Package Includes</h1>
      ...
      <section className="bg-gray-200 py-10">
        <div className="flex flex-wrap justify-center gap-20 my-10">
          <div className="flex flex-col items-center justify-center p-8 rounded-lg text-center w-[18rem]">
            <img
