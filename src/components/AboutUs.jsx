...
const AboutUs = () => {
  return (
    <section id="about" className="about-section py-16  p-2">
        ...
        <div className="about-dis">
          ...
          <span className="card-text1">Protoheim Pvt Ltd is a team of electonics and embedded systems<br/>enthusiasts.Our journey began in 2021 </span>
        </div>
  ...
  <p className="icon-header2">We strive to be at the forefront of the<br/>technological revolution</p>
</div>
</div>
