  ...
  return (
    <footer className="bg-[#283891] text-white p-4 flex flex-col items-center justify-center gap-4 text-center h-[400px]">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-4">
        <a href="#" className="text-md hover:underline font-thin tracking-wider">Contact us</a>
        <a href="#" className="text-md hover:underline font-thin tracking-wider">Products</a>
        <a href="#" className="text-md hover:underline font-thin tracking-wider">About us</a>
        <a href="#" className="text-md hover:underline font-thin tracking-wider">Services</a>
