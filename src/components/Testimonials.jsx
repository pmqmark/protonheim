...
const Testimonials = () => {
  ...
  const quoteHeadingStyle = {
    ...
    textAlign: 'center',
    color: 'rgba(22, 28, 45, 1)', // Updated color
    marginBottom: '20px', // Ensure there's space below the quote heading
  };
  ...
  return (
    <section className="p-3">
      <div className="text-center mb-8">
        <h5 style={headingStyle}>TESTIMONIALS</h5>
        <span style={quoteHeadingStyle}>What people say about us</span>
          ...
          <div className="card" style={cardStyle}>
            ...
            <div className="card-body">
              <p style={cardTextStyle}>
                “You made it so simple. My<br /> new site is so much faster<br /> and easier to work with than<br /> my old site.”
              </p>
              <a href="#" style={authorLinkStyle}>Isabella Chavez</a>
            </div>
          </div>
        </div>
        <div className="img-cards2">
          <div className="card" style={cardStyle}>
            ...
            <div className="card-body">
              <p style={cardTextStyle}>
                “Simply the best. Better than<br /> all the rest. I’d recommend this product to beginners and<br /> advanced users.”
              </p>
              <a href="#" style={authorLinkStyle}>Curtis Rhodes</a>
            </div>
          </div>
        </div>
        <div className="img-cards2">
          <div className="card" style={cardStyle}>
            ...
            <div className="card-body">
              <p style={cardTextStyle}>
                “Must have book for all, who<br /> want to be Product Designer or<br /> Interaction Designer.”
              </p>
              <a href="#" style={lucasMannStyle}>Lucas Mann</a> {/* Apply special style here */}
            </div>
          </div>
        </div>
      </div>
